...
Date:3 March 2023
File name for script: BLM_boundaries_TraC_Transparency.Rmd
...
#LEFT HERE
dat.IC.mac2.NEA <- dat.IC.mac2.NEA %>%
...
out <- modBLM(df=dat.IC.mac2.NEA ,plt = FALSE, x=SE,y=BiotaClass,min_new.x=1,max_new.x=1,logarithm=TRUE)
...
df <- dat.IC.mac2.NEA  #select data to plot
