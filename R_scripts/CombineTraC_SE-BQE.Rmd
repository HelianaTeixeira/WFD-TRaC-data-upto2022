...
* From WISE2, source disaggregated EQR & EQS data summarised (mean) by Year and Site was used except for EE, IE and SI for which only already aggregated data by site was available, so the later was also extracted; data for all years available until 2023.
