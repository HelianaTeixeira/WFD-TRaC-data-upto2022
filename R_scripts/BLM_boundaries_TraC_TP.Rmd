...
SE <- "TP_µgL.1"    # name of data column containing SE in data file        
...
IC.GM_MS1 <- 0.39 # EDIT: MS IC EQS boundary if not using normalised EQR
IC.GM_MS2 <- 0.51 # add more MS if needed (and reflect in "Functions_BLM_EQR.R" to get all hlines in Fig1d)

#EDIT: Run model and calculate measures, remember to edit line to  match dataframe name created in line above!
out <- modBLM(df=datIC.TP.MedPolyCL ,plt = FALSE, x=SE,y=BiotaClass,min_new.x=1,max_new.x=1,logarithm=TRUE)
